...
public class WizardControllerIntegrationTest {
    ...
    void testAddWizardSuccess() throws Exception {
        ...
        this.mockMvc.perform(post(this.baseUrl + "/wizards/add").contentType(MediaType.APPLICATION_JSON).content(json).accept(MediaType.APPLICATION_JSON).header(HttpHeaders.AUTHORIZATION, this.token))
                .andExpect(jsonPath("$.flag").value(true))
                .andExpect(jsonPath("$.code").value(StatusCode.SUCCESS))
