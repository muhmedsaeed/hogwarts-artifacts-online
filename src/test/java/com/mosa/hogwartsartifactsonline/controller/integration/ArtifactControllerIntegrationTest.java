package com.mosa.hogwartsartifactsonline.controller.integration;
...
public class ArtifactControllerIntegrationTest {
    ...
    void testAddArtifactSuccess() throws Exception {
        ...
        // When and then
        this.mockMvc
                .perform(post(this.baseUrl + "/artifacts/add")
                        .contentType(MediaType.APPLICATION_JSON)
                        .header(HttpHeaders.AUTHORIZATION, this.token) // for login security
                        .content(json)
    ...
    void testAddArtifactErrorWithInvalidInput() throws Exception {
        ...
        this.mockMvc.perform(post(this.baseUrl + "/artifacts/add").contentType(MediaType.APPLICATION_JSON).content(json).accept(MediaType.APPLICATION_JSON).header(HttpHeaders.AUTHORIZATION, this.token))
                .andExpect(jsonPath("$.flag").value(false))
